...
_node.js 基础笔记[update 2025-01-18]_

[about_development/about_js/about_nodejs.md]

[返回索引](../../README.md)

- [查看仓库](https://github.com/nodejs/node)
- [官方文档](https://nodejs.org/docs/latest/api/synopsis.html)
- [官方入门教程](https://nodejs.org/en/learn/getting-started/introduction-to-nodejs)
...
- npm 是 Node.js 的标准包管理器
    npm install  # 安装 package.json 的依赖, 或者单独包(pnpm 使用 pnpm add)
    npm update
...
```bash
# 每个项目定义要使用的包管理器版本.
# 官方的 Node.js 工具, 由 Yarn 与 Node.js 项目联手开发.
# 无需安装 Yarn、npm 和 pnpm 即可使用.
# Installation:
    corepack enable #node.js内置,无需安装,但需要激活(全局激活)
```
...
# 常用指令
    ...
    pnpm list | pnpm list -g
    pnpm remove | pnpm uninstall
...
```bash
# nodejs 老牌环境管理工具, 但 fnm 更符合现代设计, 推荐使用 fnm
```
